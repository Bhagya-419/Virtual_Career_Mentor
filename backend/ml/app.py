...
def normalize_skills(skills_text):
    skill_aliases = {
        # --- React / Frontend ---
        "react.js": "react", "reactjs": "react", "react native": "react", "react js": "react",
        "node.js": "node", "nodejs": "node", "node js": "node",
        "vue.js": "vue", "vuejs": "vue", "vue js": "vue",
        "angular.js": "angular", "angularjs": "angular",
        "javascript": "javascript", "js": "javascript", "java script": "javascript",
        ...
        # --- Python / Backend ---
        "python3": "python", "py": "python",
        "django rest": "django", "flask api": "flask",
        "php8": "php", "laravel framework": "laravel", "symfony framework": "symfony",
        "express.js": "express", "expressjs": "express",
        "hibernate orm": "hibernate", "spring framework": "spring", "spring boot framework": "spring boot",

        # --- Data & ML ---
        "ml": "machine learning", "machine-learning": "machine learning",
        "dl": "deep learning", "deep-learning": "deep learning",
        "natural language processing": "nlp", "natural-language-processing": "nlp",
        "tf": "tensorflow", "tensor flow": "tensorflow", "keras api": "keras",
        "data viz": "data visualization", "data-visualization": "data visualization",
        "data analysis": "data analysis", "data-analysis": "data analysis",
        "data science": "data science", "pandas library": "pandas",
        "statistics": "statistics", "stats": "statistics",
        "r language": "r", "r programming": "r",
        ...
        "docker container": "docker", "dockerfile": "docker",
        "k8s": "kubernetes", "kube": "kubernetes",
        "terraform iac": "terraform", "ansible automation": "ansible",
        "helm chart": "helm", "helm charts": "helm",
        "cicd": "ci/cd", "ci cd": "ci/cd",
        "continuous integration": "ci/cd", "jenkins pipeline": "jenkins",
        "linux os": "linux", "ubuntu": "linux", "unix": "linux",
        "microservice": "microservices", "micro services": "microservices",

        # --- Mobile ---
        "ios development": "ios", "ios dev": "ios",
        "android development": "android development", "android sdk": "android sdk",
        "objective c": "objective-c", "objc": "objective-c",
        "swift language": "swift", "kotlin lang": "kotlin",
        "xcode ide": "xcode", "core data framework": "core data",

        # --- Cybersecurity ---
        "ethical hacking": "ethical hacking", "ethicalhacking": "ethical hacking",
        "pen testing": "penetration testing", "pentest": "penetration testing", "pentesting": "penetration testing",
        "network sec": "network security", "firewall": "firewalls", "siem tools": "siem",
        ...
        "adobe xd": "adobe xd", "xd": "adobe xd",
        "adobe illustrator": "adobe illustrator", "illustrator": "adobe illustrator",
        "figma design": "figma", "sketch app": "sketch",
        "wire frame": "wireframing", "wireframe": "wireframing",
        "prototype": "prototyping", "photoshop": "photoshop", "ps": "photoshop",
        "3d modelling": "3d modeling",

        # --- Blockchain ---
        "solidity lang": "solidity", "smart contract": "smart contracts",
        "web 3": "web3", "web3.js": "web3", "web3 js": "web3", "web3js": "web3js",
        "eth": "ethereum",

        # --- Project Management / Soft Skills ---
        "agile methodology": "agile", "scrum methodology": "scrum", "jira tool": "jira",
        "project mgmt": "project management", "stakeholder mgmt": "stakeholder management",
        "hr management": "hr management", "hr policies": "hr policies", "employee relation": "employee relations",

        # --- Marketing / Analytics ---
        "seo optimization": "seo", "search engine optimization": "seo",
        "ppc ads": "ppc", "pay per click": "ppc",
        "google analytics tool": "google analytics", "ga": "google analytics",
        "digital marketing": "digital marketing", "social media marketing": "social media",
        "content marketing": "content creation", "marketing campaign": "marketing campaigns",

        # --- Finance ---
        "financial model": "financial modeling", "risk mgmt": "risk analysis", "risk management": "risk analysis",
        "ms excel": "excel", "microsoft excel": "excel", "tableau software": "tableau",

        # --- Game Dev ---
        "unity engine": "unity", "unity3d": "unity",
        "unreal": "unreal engine", "ue5": "unreal engine",
        "vr dev": "vr development", "virtual reality": "vr", "game physics engine": "game physics",
    }
...
def predict():
    ...
    try:
        ...
        # Create input dataframe matching expected column names
        input_df = pd.DataFrame([[skills, qualification, experience_level]], 
                                columns=["skills", "qualification", "experience_level"])
        ...
        top3 = [
            {
                "role": str(classes[i]),
                "match_score": round(float(probabilities[i]) * 100, 2)
            }
            for i in top3_idx
        ]
